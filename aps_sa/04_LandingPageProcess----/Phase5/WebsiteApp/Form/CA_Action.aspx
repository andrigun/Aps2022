<%@ Page Language="vb"  AutoEventWireup="false" CodeBehind="CA_Action.aspx.vb" Inherits="WebsiteApp.CA_Action" %>
...
<title>Halaman Review oleh CA</title>
     ...
     <script  type="text/javascript">
         ...
         $(document).ready(function() {
			 ...
			 function WaitSaving() {
				...
				savedata(setstatus, note, user, cabang, dataid, surveyI);
        }

         function savedata(setstatus, note, user, cabang, dataid, surveyI) {
             ...
             dataPassed.surveyI = surveyI
                ...
                showMsgBox('Informasi', str, 'Tutup', '', 'closetab()', '', 300,'');
                 ...
                 error: function(XMLHttpRequest, textStatus, errorThrown) {zzz
			 ...
			 function GetLocalValueReview() {     
			    ...
			    //	 alert(setstatus + ',' + user + ',' + note + ',' + cabang + ',' + dataid);
			 }     
...
<%--	<asp:Button ID="btnsendemail" runat="server" Text="btnsendemail"  Style="display: block"  OnClick="btnsendemail_Click" />--%>
<br />
