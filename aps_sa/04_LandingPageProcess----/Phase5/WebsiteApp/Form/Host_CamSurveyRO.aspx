<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Host_CamSurveyRO.aspx.vb" Inherits="WebsiteApp.Host_CamSurveyRO" %>
...
<table runat="server"  cellSpacing='0' cellPadding='0'  border='0' width="793px" align="left">
	...
	<div><ucCamSurvey:WebControl4 ID="camSurvey" runat="server" /></div>
    </form>
</body>
</html>
