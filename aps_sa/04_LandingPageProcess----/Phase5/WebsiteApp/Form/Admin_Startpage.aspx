<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Admin_Startpage.aspx.vb" Inherits="WebsiteApp.Admin_Startpage" %>
    ...
    <script type="text/javascript">
            ...
            CallDataGrid(Akses, BranchId, "", "", 1, "", "");
				...
				$("#btnSearch").click(function () {
					...
					document.getElementById("txtDocPro").value = "%"
            ...
            document.getElementById("txtCustName").value="%";
				...
				//Event klik button SearchDocPro
			$("#btnSearchDocPro").click(function () {
							 document.getElementById("txtCustName").value="%"
             if (document.getElementById("txtDocPro").value=="")
            {
            document.getElementById("txtDocPro").value="%";
					}

				SearchDocPro = document.getElementById("txtDocPro").value;

					frmMain.hdnstatusid.value = '';

				document.getElementById("hdnfiltering1").value = "DocPro";
					document.getElementById("hdnfiltering2").value = SearchDocPro;
				document.getElementById("hdnfiltering3").value = SearchDocPro;

				  varfiltering1 = "DocPro"
					varfiltering2 = SearchDocPro;
					varfiltering3= SearchDocPro;
			...
			//	CallDataPageList(Akses, "allstatus", SearchName, BranchId, 1, varsortby, varsortmethod, "", "", "");
				...
				CallDataPageList(Akses, "allstatus", SearchDocPro, BranchId, 1, varsortby, varsortmethod, varfiltering1, varfiltering2, varfiltering3);
      ...
      function CallDataGrid(Akses, BranchId, Str2, Str3, Page, OrderBy, AscDesc) //fungsi untuk menampilkan data Grid
      {
            ...
            $.ajax({
                type: "POST",
                url: "Admin_Postback.asmx/displayDataPageStatus",
                //data: "{}",
      ...
      //Function number : 05   
       function CallDataPageList(Akses,StatusId,SearchName,BranchId, Page, OrderBy, AscDesc, Filtering1, Filtering2, Filtering3) //fungsi untuk menampilkan data Grid
			 {     
            var Scrip;
            ...
            dataPassed.OrderBy = OrderBy;
				 dataPassed.AscDesc = AscDesc;
				 dataPassed.filtering1 = Filtering1;
				 dataPassed.filtering2 = Filtering2;
				 dataPassed.filtering3 = Filtering3;
            $.ajax({
                type: "POST",
                url: "Admin_Postback.asmx/displayDataPageStatusList",
                //data: "{}",
                data: $.toJSON(dataPassed),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<table cellpadding="0" cellspacing="0" border="0" height="39" width="100%">
		<tr>
			...
			<font style="font-size:large; font-weight:bold;color:#00A321">Dashboard Multiguna - LOS</font><br />
               <font style="font-size:smaller;color:#00A321">Admin Screen - List Data - <asp:Label ID="userid" runat="server" Text="Label"></asp:Label> (<asp:Label ID="branchid" runat="server" Text="Label"></asp:Label>)</font>
			</td>
		</tr>
</table>
...
<tr>
    <td>
	 ...
	 <table border="0"  align="left" style="border-collapse: collapse;" height="30px" cellspacing="0" cellpadding="0" >   
            <tr>
                <td style="width:83px;" >PIC </td> 
                <td style="width:100px;" >           
                    <asp:TextBox ID="txtDocPro" runat="server"  >%</asp:TextBox>
                    </td>
                    <td align="left">
                    <input type="button" id="btnSearchDocPro" class="cssButton3" value="Search PIC Name" style="margin-left:5px;width:130px;" />
                </td>
            </tr> 
        </table>
		</td>
...
<td style="color: burlywood"><input id="hdnfiltering1" name="hdnfiltering1" runat="server" style="display:none;color: burlywood;border:none" /></td>
<td style="color: burlywood"><input id="hdnfiltering2" name="hdnfiltering2" runat="server" style="display:none;color: burlywood;border:none" /></td>
<td style="color: burlywood"><input id="hdnfiltering3" name="hdnfiltering3" runat="server" style="display:none;color: burlywood;border:none" /></td>
</tr>
</table>
<!-- paramater check END -->
<div id="divMsgBox"  >  
