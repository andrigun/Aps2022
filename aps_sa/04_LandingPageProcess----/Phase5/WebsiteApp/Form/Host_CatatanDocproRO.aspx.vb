...
Public Class Host_CatatanDocproRO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Session("reffumber") = reffnumber
            Session("reffumberacak") = reffnumberacak
        Else
            reffnumber = Session("reffumber")
            reffnumberacak = Session("reffumberacak")
            varakses = Session("akses")
        End If
        TabSelector(8)
    End Sub
