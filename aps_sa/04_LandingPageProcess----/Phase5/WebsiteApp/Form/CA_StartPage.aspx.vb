...
Public Class CA_StartPage
    ...
    Protected Sub btnredirect_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnredirect.Click
        Response.Redirect(String.Format("Host_IndentitasCadebCA.aspx?isviewinvho=0&reID={0}&view=info", HttpUtility.UrlEncode(Encrypt(txtdataid.Value))))
        Exit Sub
    End Sub
