<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CalculatorCreditHistory.aspx.vb" Inherits="WebsiteApp.CalculatorCreditHistory" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>History Simulation Credit</title>
...
<table border="0" style="width:1000;border-collapse:collapse;" > 
        <tr>
            <td><h3>History Simulation Credit</h3></td>
        </tr>
        <tr>
			<td>
                <table border="0">
