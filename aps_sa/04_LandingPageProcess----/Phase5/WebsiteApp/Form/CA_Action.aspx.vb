...
Public Class CA_Action
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            With oDs.Tables(0)
                ...
                If nRowList >= 0 Then
                    ...
                    If ((.Rows(x).Item("statusid") = "CBASC") Or (.Rows(x).Item("statusid") = "BMREQ")) Then
                        ...
                        If islocked = True Then             'hidden btn request survey dan drop data jika sedang di liat CA yg lain
                    ...
                    Else
                        ...
                        'If usrRequestSurvey = "" Then
                        btnRQSVY.Visible = False
                        btnDROPD.Visible = False
                        'Else
                        'btnRQSVY.Visible = True
                        'btnDROPD.Visible = True
                        'btnRQSVY.Style("display") = "none"
                        'End If
            ...
            '	sTable = sTable & "<table cellspacing='0' cellpadding='2' id='DtgAsset'>"
    ...
    Protected Sub btncekasiri_Click(sender As Object, e As EventArgs) Handles btncekasiri.Click
        ...
        ''call api section
        'testing hardcodex
        'cekasliri("req1223456", "3245643743930", "Restu jaya", "23-12-1982", "Bogor", "08156987456", var_userid)
