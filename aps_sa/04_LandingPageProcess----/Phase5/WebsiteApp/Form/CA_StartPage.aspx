<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CA_StartPage.aspx.vb" Inherits="WebsiteApp.CA_StartPage" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<meta http-equiv="x-ua-compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0"> 
    <title>Credit Analyst Screen</title>
 ...
 <!-- <link href="../css/jquery.ui.all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
      ...
      function CallDataGrid(Akses, BranchId, Str2, Str3, Page, OrderBy, AscDesc) //fungsi untuk menampilkan data Grid
      {
            ...
            $.ajax({
                type: "POST",
                url: "CA_Postback.asmx/displayDataPageStatus",
                //data: "{}",
      ...
      //Function number : 05   
       function CallDataPageList(Akses,StatusId,SearchName,BranchId, Page, OrderBy, AscDesc) //fungsi untuk menampilkan data Grid
        {     
            ...
            $.ajax({
                type: "POST",
                url: "CA_Postback.asmx/displayDataPageStatusList",
                //data: "{}",
                data: $.toJSON(dataPassed),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<table cellpadding="0" cellspacing="0" border="0" height="39" width="100%">
		<tr>
			...
			<font style="font-size:large; font-weight:bold;color:#00A321">Dashboard Multiguna - LOS</font><br />
               <font style="font-size:smaller;color:#00A321">CRA Screen - List Data - <asp:Label ID="userid" runat="server" Text="Label"></asp:Label> (<asp:Label ID="branchid" runat="server" Text="Label"></asp:Label>)</font>
			</td>
		</tr>
</table>
